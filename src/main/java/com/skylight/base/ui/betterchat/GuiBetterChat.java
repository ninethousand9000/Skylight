package com.skylight.base.ui.betterchat;
...
public class GuiBetterChat extends GuiNewChat {
    ...
    public ITextComponent getChatComponent(int mouseX, int mouseY) {
        if (!this.getChatOpen()) {
            ...
            int j = mouseX / i - 2 - BetterChat.xOffset.getValue();
            int k = mouseY / i - 40 + BetterChat.yOffset.getValue();
